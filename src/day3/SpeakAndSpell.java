...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		speak("Spell Xylophone");
		String words = JOptionPane.showInputDialog("Spell");
		// 2. Catch the user's answer in a String
		if (words.equalsIgnoreCase("Xylophone")) {
		...
		speak("Spell Talkitive");
		String wordss = JOptionPane.showInputDialog("Spell");
		if (wordss.equalsIgnoreCase("Talkitive")) {
